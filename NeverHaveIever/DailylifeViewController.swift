...
class DailylifeViewController: UIViewController,UITableViewDataSource,UITableViewDelegate{
    ...
    // 学校・仕事
    let school = ["面接中に嘘をついた","一生のお願いを乱用した","正直、可愛い女にムカついた","好きな人に意地悪をした","テストでカンニングした","元ヤンキーだった","年収500万以上は稼いだ","便所飯をした","バレンタインチョコをもらえなかった"
        ,"経費で私的流用した","会議中に寝た",
    "アルバイトをばっくれた（とんだ）","副業したことが"]

    //恋愛
    let love = ["映画/漫画のような恋をした"
    ...
    //  おすすめ
    let recommendation = ["裏垢を作った","公共のトイレで水が流れなくて、困った","酔い潰れて、、、","精神科医に行った","出会い、婚活系アプリに登録した","水と日本酒を間違えた","","なんかはわからないけど、涙が勝手に流れた"
    ,"売れないバンドが人気になり、寂しくなった","生きるのがしんどくなった","一晩で10万円以上使った","友達の「秘密だよ」って話を秘密にしなかった","もうすでにこのアプリで嘘をついた"]
