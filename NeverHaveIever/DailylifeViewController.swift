...
class DailylifeViewController: UIViewController,UITableViewDataSource,UITableViewDelegate{
    ...
    // 学校・仕事
    let school = ["テストでカンニングした","元ヤンキーだった","年収500万以上は稼いだ","便所飯をした","バレンタインチョコをもらえなかった"
        ,"経費で私的流用した","会議中に寝た",
    ...
    //  おすすめ
    let recommendation = ["裏垢を作った","烏龍茶と間違えてウイスキーを飲んだ","酔い潰れて、、、","精神科医に行った","出会い、婚活系アプリに登録した","三頭身と三親等を間違えた",
        "カルピス、牛乳、練乳で何かを想像した",
        "もうすでにこのアプリで嘘をついた"]
